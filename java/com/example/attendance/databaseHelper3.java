...
public class databaseHelper3 extends SQLiteOpenHelper {
    ...
    public databaseHelper3(Context context) {
        super(context, "student3.db", null, 1);
    }
    ...
    public int clearData2()
    {
        ...
        return db.delete("csethirdyear",null,null);
    }
                               ...
                               String fiftyone,String fiftytwo,String fiftythree,String fiftyfour,String fiftyfive,String fiftysix,String fiftyseven,String fiftyeight,String fiftynine,String sixty)
    {
        ...
        long check = db.insert("csethirdyear",null,contentValues);
        if(check!=-1)
        {
            return true;
        }
    ...
    {
        SQLiteDatabase db=this.getWritableDatabase();
        Cursor res=db.rawQuery("select * from csethirdyear",null);
        return res;
    }
}
