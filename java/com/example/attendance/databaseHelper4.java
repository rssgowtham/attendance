...
public class databaseHelper4 extends SQLiteOpenHelper {
    ...
    public databaseHelper4(Context context) {
        super(context, "student4.db", null, 1);
    }
    ...
    public int clearData2()
    {
        ...
        return db.delete("csefourthyear",null,null);
    }
                               ...
                               String fiftyone,String fiftytwo,String fiftythree,String fiftyfour,String fiftyfive,String fiftysix,String fiftyseven,String fiftyeight,String fiftynine,String sixty)
    {
        ...
        long check = db.insert("csefourthyear",null,contentValues);
        if(check!=-1)
        {
            return true;
        }
    ...
    {
        SQLiteDatabase db=this.getWritableDatabase();
        Cursor res=db.rawQuery("select * from csefourthyear",null);
        return res;
    }
}
